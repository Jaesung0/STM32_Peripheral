...
#define UART_IsActiveFlag_PE(UARTX)   (UARTX)->ISR & 0x00000001
#define UART_IsActiveFlag_FE(UARTX)   (UARTX)->ISR & 0x00000002
#define UART_IsActiveFlag_NE(UARTX)   (UARTX)->ISR & 0x00000004
#define UART_IsActiveFlag_ORE(UARTX)  (UARTX)->ISR & 0x00000008
#define UART_IsActiveFlag_RXNE(UARTX) (UARTX)->ISR & 0x00000020
#define UART_IsActiveFlag_TC(UARTX)   (UARTX)->ISR & 0x00000040
#define UART_IsActiveFlag_TXE(UARTX)  (UARTX)->ISR & 0x00000080
#define UART_ClearFlag_PE(UARTX)      (UARTX)->ICR = 0x00000001
#define UART_ClearFlag_FE(UARTX)      (UARTX)->ICR = 0x00000002
#define UART_ClearFlag_NE(UARTX)      (UARTX)->ICR = 0x00000004
#define UART_ClearFlag_ORE(UARTX)     (UARTX)->ICR = 0x00000008
