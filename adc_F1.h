...
#define ADC1_CONV_FREQ     20     //1초당 변환수
#define ADC1_NBR_OF_CH     3      //채널합계, MX_ADC1_Init(void) 함수의 hadc1.Init.NbrOfConversion 과 동일하게 설정
#define ADC1_NBR_OF_OVS    5      //오버샘플수
#define ADC1_VREFINT_RANK  1      //MCU내부 1.2V기준전압 채널의 랭크
